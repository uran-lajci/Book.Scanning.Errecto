#!/usr/bin/env bash
# Runs cpp_scripts/c_incunabula_greedy.cpp on all instances/*.txt
# Usage: ./run_c_incunabula_greedy.sh [SEED]
set -o pipefail
...
CPP_SRC="$ROOT_DIR/cpp_scripts/c_incunabula_greedy.cpp"
BIN="$ROOT_DIR/cpp_scripts/c_incunabula_greedy"
INST_DIR="$ROOT_DIR/instances"
OUT_DIR="$ROOT_DIR/output/c_incunabula_greedy"
