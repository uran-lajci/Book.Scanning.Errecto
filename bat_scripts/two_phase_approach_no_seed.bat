...
if not exist "..\output\two_phase_approach_no_seed" mkdir "..\output\two_phase_approach_no_seed"
...
for %%f in (..\instances\*.txt) do (
    ...
    ..\cpp_scripts\two_phase_approach.exe < "%%f" > "..\output\two_phase_approach_no_seed\!filename!.out" 2> "..\output\two_phase_approach_no_seed\!filename!.log"
    ...
    if errorlevel 1 (
        ...
        echo   ^> SUCCESS: Output saved to ..\output\two_phase_approach_no_seed\!filename!.out
...
echo Results saved in: ..\output\two_phase_approach_no_seed\
echo ========================================
echo.
